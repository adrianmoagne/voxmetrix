...
import S from "./ExperimentParticipantTextHighlighting.styles";

type Step = "welcome" | "consent" | "form" | "experiment" | "completed";

const ExperimentParticipantTextHighlighting = () => {
...
export default ExperimentParticipantTextHighlighting;
